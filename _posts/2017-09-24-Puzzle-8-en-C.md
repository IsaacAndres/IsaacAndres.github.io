...
El siguiente programa simula el juego del puzzle 8, el cual consiste en una matriz de 3x3 con los números del 1 al 8 los cuales deben ordenar moviendo los números con las teclas w,a,s,d en un máximo de 40 movimientos. El programa debe dividirse en 2 archivos, el  main (puzzle.c) y el header (puzzle.h) que contendra todas las funciones.
